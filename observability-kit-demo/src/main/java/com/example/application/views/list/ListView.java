...
public class ListView extends Div {
    ...
    private void createAmountColumn() {
        amountColumn = grid
                .addEditColumn(Client::getAmount,
                        new NumberRenderer<>(Client::getAmount,
    ...
    private void createDateColumn() {
        dateColumn = grid
                ...
                .setComparator(Client::getDate).setHeader("Date")
    ...
    private void addFiltersToGrid() {
        ...
        dateFilter.addValueChangeListener(event -> gridListDataView
