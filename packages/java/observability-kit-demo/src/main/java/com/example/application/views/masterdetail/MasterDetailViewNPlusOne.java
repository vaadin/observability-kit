...
@Route(value = "master-detail-nplusone/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Uses(Icon.class)
@PermitAll
public class MasterDetailViewNPlusOne extends Div
        implements BeforeEnterObserver {

    private static final String SAMPLEPERSON_ID = "samplePersonID";
    private static final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "master-detail-nplusone/%s/edit";
    ...
    @Autowired
    public MasterDetailViewNPlusOne(SamplePersonService samplePersonService) {
